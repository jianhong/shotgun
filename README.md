...
[![AWS CI](https://img.shields.io/badge/CI%20tests-full%20size-FF9900?labelColor=000000&logo=Amazon%20AWS)](https://nf-co.re/shotgun/results)
...
3. Download the pipeline and test it on a minimal dataset with a single command:
    ...
    ```console
    nextflow run jianhong/shotgun -profile test,YOURPROFILE
    ```
...
4. Start running your own analysis!
    ...
    ```console
    nextflow run jianhong/shotgun -profile <docker/singularity/podman/shifter/charliecloud/conda/institute> --input samplesheet.csv --genome GRCh37
    ```
...
<!-- If you use  jianhong/shotgun for your analysis, please cite it using the following doi: [10.5281/zenodo.XXXXXX](https://doi.org/10.5281/zenodo.XXXXXX) -->
