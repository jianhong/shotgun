...
## :warning: Please read this documentation on the nf-core website: [https://nf-co.re/shotgun/usage](https://nf-co.re/shotgun/usage)
...
```console
nextflow run jianhong/shotgun --input samplesheet.csv --genome GRCh37 -profile docker
```
